  ...
  $(document).on('click', '.navbar-collapse.in', function(hideMenu) {
    ...
    $(document).ready(function() {
      $(".left-arrow button").click(function() {
          var currentSelected = $(".cd-horizontal-timeline .timeline .events a.selected");
          if (currentSelected.parent().prev().length) {
              currentSelected.parent().prev().children('a').click();
          }
      });
  
      $(".right-arrow button").click(function() {
          var currentSelected = $(".cd-horizontal-timeline .timeline .events a.selected");
          if (currentSelected.parent().next().length) {
              currentSelected.parent().next().children('a').click();
          }
      });
  });